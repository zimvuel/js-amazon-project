...
import {getDelivery, deliveryOptions } from "../../data/deliveryOption.js";
...
export function renderOrderSummary(){
  ...
  document.querySelector('.js-checkout-header').innerHTML = `Checkout (<a class="return-to-home-link"
